# Alex Brush Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Alex Brush is a beautifully flowing brush script designed by the
[Alex Brush Project Team](https://github.com/googlefonts/alex-brush). It has
short ascenders and descenders allowing a legibility not seen in other script
fonts.
...
```
Title: Alex Brush Font
Creators: The Alex Brush Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-alex-brush
UUID: 9698D160-935A-4B2E-870D-228FA7E8887C
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-alex-brush
```
